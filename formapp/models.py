...
class Simulacion(models.Model):
    ...
    def __str__(self):
        return f'{self.id_user} {self.user} {self.nombre_simulacion} {self.description} {self.created_at} {self.updated}'
...
class FormSim(models.Model):
    ...
    procesos = models.ManyToManyField('Procesos', blank=True)
    ...
    unidad_potencia = models.ForeignKey(
        'Unidad_Potencia', on_delete=models.CASCADE, null=True, default='kW')
    presion_caldera = models.FloatField(
        max_length=300, verbose_name="Presión de la Caldera")
    unidad_presion = models.ForeignKey(
        'Unidad_Presion', on_delete=models.CASCADE, null=True, default='bar')
    ...
    unidad_flujo_masico = models.ForeignKey(
        'Unidad_Flujo_Masico', on_delete=models.CASCADE, null=True, default='kg/s')
    ...
    def __str__(self):
        return f'{self.nombre_simulacion}{self.aplicacion}{self.demanda_anual} {self.demanda_enero} {self.demanda_febrero} {self.demanda_marzo} {self.demanda_abril} {self.demanda_mayo} {self.demanda_junio} {self.demanda_julio} {self.demanda_agosto} {self.demanda_septiembre} {self.demanda_octubre} {self.demanda_noviembre} {self.demanda_diciembre} {self.demanda_lun} {self.demanda_mar} {self.demanda_mie} {self.demanda_jue} {self.demanda_vie} {self.demanda_sab} {self.demanda_dom} {self.potencia_caldera} {self.presion_caldera} {self.temperatura_red} {self.temperatura_retorno} {self.t_enero} {self.t_febrero} {self.t_marzo} {self.t_abril} {self.t_mayo} {self.t_junio} {self.t_julio} {self.t_agosto} {self.t_septiembre} {self.t_octubre}  {self.t_noviembre} {self.t_diciembre} {self.t_salida} {self.area_apertura} {self.eficiencia_optica} {self.coef_per_lineales} {self.coef_per_cuadraticas} {self.potencia_caldera} {self.unidad_potencia} {self.presion_caldera} {self.unidad_presion} {self.tipo_caldera} {self.precio_colector} {self.cantidad_bat} {self.col_bat} {self.total_colectores} {self.sup_colectores} {self.inclinacion_col} {self.azimut} {self.flujo_masico} {self.volumen} {self.efectividad} {self.costo_combustible} {self.iam_longitudinal}'
